...
test('Admin Directory Access Objects Search flow', async ({ page }) => {
  await page.goto('/listing/setup/directory/accessObjectView');
  ...
  console.log('Searching access object:', value);
