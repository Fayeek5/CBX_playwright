...
test('Library Packaging Search flow', async ({ page }) => {
  await page.goto('/');
  ...
  console.log('Packaging page URL:', page.url());
  ...
  if (!hasLink) {
    throw new Error('No records found in Library Packaging — marking as FAILED');
  }
  ...
  console.log('Searching packaging:', value);
