...
test('Admin Application Configuration Conditions Search flow', async ({ page }) => {
  await page.goto('/');
  ...
  // Click Application Configuration — lands directly on Conditions listing
  ...
  console.log('Conditions page URL:', page.url());
  ...
  if (!hasLink) {
    throw new Error('No records found in Application Configuration Conditions — marking as FAILED');
  }
  ...
  console.log('Searching condition:', value);
