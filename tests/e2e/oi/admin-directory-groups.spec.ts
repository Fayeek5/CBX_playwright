...
test('Admin Directory Groups Search flow', async ({ page }) => {
  await page.goto('/listing/setup/directory/groupView');
  ...
  console.log('Searching group:', value);
  ...
  await page.waitForURL(/\/document\/|\/setup\/group\/|\/setup\/directory\/group\//, { timeout: 30000 });
  await page.waitForLoadState('domcontentloaded');
