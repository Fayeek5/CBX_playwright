...
test('Library Components Search flow', async ({ page }) => {
  await page.goto('/');
  ...
  console.log('Components page URL:', page.url());
  ...
  if (!hasLink) {
    throw new Error('No records found in Library Components — marking as FAILED');
  }
  ...
  console.log('Searching component:', value);
