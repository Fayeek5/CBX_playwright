...
test('test', async ({ page }) => {
  await page.goto('https://oi-upgrade-qa.tradebeyond.com/listing/shipment/shipmentAdvice/shipmentAdviceView');
  ...
  await page.getByRole('link', { name: 'SAV2606-000016' }).click();
